...
const LiveExamWrapper = () => {
  ...
  const fetchExamData = async () => {
    try {
      ...
      console.error(err);
      alert('Failed to start exam. It might be inactive or missing questions.');
  ...
  const handleViolation = useCallback(() => {
    ...
    setWarnings(prev => {
      ...
      alert(`WARNING ${newWarnings}/3: Tab switching or exiting fullscreen is prohibited.`);
